package com.shortthirdman.core.algorithm.dynamicprogramming;
 
import java.util.Scanner;
 
public class OptimalParanthesization {
    private int[][] m;
    private int[][] s;
    private int     n;
 
    public OptimalParanthesization(int[] p) {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++)
            arr[i] = sc.nextInt();
        OptimalParanthesization opudp = new OptimalParanthesization(
                arr);
