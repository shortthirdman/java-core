...
public class UpdateRecord {
    ...
    public static final String QUERY = "UPDATE records SET title = ?, release_date = ? WHERE id = ?";

    private DataSource dataSource;

    public UpdateRecord(DataSource dataSource) {
        this.dataSource = dataSource;
    }

    public static void main(String[] args) {
        DataSource ds = getDataSource();
        UpdateRecord demo = new UpdateRecord(ds);
    ...
    public static DataSource getDataSource() {
        ...
        ds.setDriverClassName(UpdateRecord.DRIVER);
        ds.setUrl(UpdateRecord.URL);
        ds.setUsername(UpdateRecord.USERNAME);
        ds.setPassword(UpdateRecord.PASSWORD);
        return ds;
    }
}